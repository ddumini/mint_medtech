  ...
  <div class="inner">
    ...
    <div class="board-view">
      ...
      <ul class="board-view-nav">
        <li>
          <span class="lb">이전글<img src="/assets/images/common/icon_prev.png" alt="" width="8" height="5" /></span
          >이전글이 없습니다.
        </li>
        <li>
          <span class="lb">다음글<img src="/assets/images/common/icon_next.png" alt="" width="8" height="5" /></span
