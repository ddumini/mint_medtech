...
<div id="container" class="main-page">
  ...
  <section class="main-medicine">
    <div class="inner">
      <figure><img src="/assets/images/main/main_medicine_logo.png" alt="mint medtech logo" /></figure>
      <div class="main-tit__area">
        <strong>Bringing Innovative Medicine</strong>
  ...
  <section class="main-partner">
    <div class="inner02">
      <div class="main-tit__area">
        <strong>
          Mint MedTech is a <span>trusted partner</span><br />
          for Asian market expansion
        </strong>
        <p>
          We’re a dedicated partner of healthcare companies worldwide<br />
          aiming to penetrate Asian markets. From navigating regulatory<br />
          hurdles to ensuring successful implementation, we’re here to<br />
          provide comprehensive support.
        </p>
      </div>
      <div class="main-partner__banner">
        <div></div>
      </div>
    </div>
    <div class="inner">
      <ul class="main-partner__desc">
        <li>
          <figure><img src="/assets/images/main/main_partner_icon01.png" alt="Regulatory Affairs" /></figure>
          <b>Regulatory Affairs</b>
          <p>
            Product registrations<br />
            and related<br />
            approvals from your<br />
            target markets
          </p>
        </li>
        <li>
